...
capacity = int(input("Informe a capacidade da cabine A: "))
students = int(input("Informe a quantidade total de alunos C: "))

realCapacity = capacity-1

if (students%realCapacity) == 0:
    print((students//realCapacity))
else:
    print((students//(realCapacity))+1)
